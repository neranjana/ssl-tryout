...
echo "----- Task copy openssl.root.cnf and replace space holder -----"
...
rm $BASE_DIR/ca/root/openssl.root.cnf-e

echo "----- Task copy openssl.root.cnf  and replace space holder finished -----"
